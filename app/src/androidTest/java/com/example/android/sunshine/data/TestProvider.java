...
//        deleteAllRecordsFromDB(); // Directly using Database Helper, instance of SQLiteOpenHelper

        deleteAllRecordsFromProvider(); // Directly using ContentResolver, which in turn will use
