...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 60 * 180; // 30 to debug notifications
    public static final int SYNC_FLEXTIME = SYNC_INTERVAL/3; // 1000 * 10 to debug notifications
    private static final long DAY_IN_MILLIS = 1000 * 10 ;
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Log.d(LOG_TAG, "SENDING WHEATHER NOTIFICATION");
    ...
    static private void setLocationStatus(Context c, @LocationStatus int locationStatus){
        ...
        // Because we are on the Background Thread, we use commit() instead of apply()
        spe.commit();
    }
}